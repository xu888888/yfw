...
$spec = $_REQUEST['spec'];//商品规格
$vender=$_REQUEST['vender'];//商品厂家
$shop=$_REQUEST['shop'];//商品卖家
...
if($rows>0){
	...
	$sql = "INSERT INTO `cart` (`product_id`,`product_img`,`product_name`,`product_num`,`product_price`,`product_spec`,`product_vender`,`product_shop`) VALUES ('$id','$img','$name','$num','$price','$spec','$vender','$shop')";
}
